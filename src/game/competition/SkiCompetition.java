...
public  class SkiCompetition extends WinterCompetition {
    ...
    public SkiCompetition(WinterArena arena, int maxCompetition, Discipline discipline, League league, Gender gender) {
    ...
    /**
     * A function that add competitor if is standing in the requirements and Throwing irregularities necessary
     * @param competitor
     */
